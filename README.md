...
```
Note: Be careful not to include the `instructor-abcb2020` to the `students` list, if so, update the proper lists and rerun __Step 2/3/5/6__. 


### Maintenance: when new student join
- Update the whitelist in __jupyterhub_config.py__ (as __Step 0b__)
- Rerun __Step 2__, __Step 3__, __Step 5__, and __Step 6__ (with corresponding `students` list in Step 6.) 
